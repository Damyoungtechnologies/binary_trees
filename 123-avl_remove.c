...
/**
 * bal - Measures balance factor of an AVL tree and performs rotations if needed
 ...
 * Return: 0 if it has no children, the successor's value otherwise
 */
 ...
 * Return: Pointer to the root after deletion
 */
